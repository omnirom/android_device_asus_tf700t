...
PRODUCT_COPY_FILES += \
    ...
    device/asus/tf700t/audio_policy.conf:system/etc/audio_policy.conf

# gps config files
PRODUCT_COPY_FILES += \
    device/asus/tf700t/gpsconfig.xml:system/etc/gps/gpsconfig.xml \
    device/asus/tf700t/gps.conf:system/etc/gps.conf \
    device/asus/tf700t/bt_vendor.conf:system/etc/bluetooth/bt_vendor.conf \
    device/asus/tf700t/get-gps-lto:system/bin/get-gps-lto
